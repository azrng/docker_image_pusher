...
镜像前缀: `registry.cn-hangzhou.aliyuncs.com/zrng`
...
```bash
docker pull registry.cn-hangzhou.aliyuncs.com/zrng/alpine:3.8
docker pull registry.cn-hangzhou.aliyuncs.com/zrng/alpine:3.8-arm64
```
...
docker pull registry.cn-hangzhou.aliyuncs.com/zrng/dotnetaspnet:6.0-arm64
...
docker pull registry.cn-hangzhou.aliyuncs.com/zrng/dotnetaspnet:10.0-arm64
...
docker pull registry.cn-hangzhou.aliyuncs.com/zrng/dotnetsdk:6.0-arm64
...
docker pull registry.cn-hangzhou.aliyuncs.com/zrng/dotnetsdk:10.0-arm64
...
docker pull registry.cn-hangzhou.aliyuncs.com/zrng/milvus:v2.5.4
```
...
docker pull registry.cn-hangzhou.aliyuncs.com/zrng/langgenius-dify-api:1.0.0
docker pull registry.cn-hangzhou.aliyuncs.com/zrng/langgenius-dify-web:1.0.0
docker pull registry.cn-hangzhou.aliyuncs.com/zrng/langgenius-dify-sandbox:0.2.10
docker pull registry.cn-hangzhou.aliyuncs.com/zrng/langgenius-dify-plugin-daemon:0.0.3-local
docker pull registry.cn-hangzhou.aliyuncs.com/zrng/langgenius-dify-plugin-daemon:0.0.6.1-local
docker pull registry.cn-hangzhou.aliyuncs.com/zrng/semitechnologies-weaviate:1.19.0
...
docker pull registry.cn-hangzhou.aliyuncs.com/zrng/ai-stream-viewer:1.0.0
```
